...
const defaultRoomObjects: RoomObject[] = [
  { id: "trophy-shelf-1", type: "trophy-shelf", x: 91, y: 86, width: 3.7, height: 4.6, blocksMovement: true },
  { id: "meet-table-1775144038804", type: "meet-table", x: 77.5, y: 27, width: 16.3, height: 10, blocksMovement: false },
  { id: "lounge-sofa-table-1775144074670", type: "lounge-sofa-table", x: 6, y: 0, width: 18.5, height: 13.8, blocksMovement: false },
  ...
  { id: "water-purifier-1775144124795", type: "water-purifier", x: 37.5, y: 0, width: 3.9, height: 8.7, blocksMovement: false },
  ...
  { id: "plant-pot-1775144429714", type: "plant-pot", x: 86.5, y: 86, width: 3.8, height: 7.6, blocksMovement: false },
  { id: "street-lamp-outdoor-1", type: "street-lamp", x: 93, y: 2.5, width: 3.2, height: 9.6, blocksMovement: false },
  { id: "street-lamp-outdoor-2", type: "street-lamp", x: 93, y: 37, width: 3.2, height: 9.6, blocksMovement: false },
  { id: "street-lamp-outdoor-3", type: "street-lamp", x: 93, y: 78, width: 3.2, height: 9.6, blocksMovement: false },
  { id: "trash-bin-outdoor-1", type: "trash-bin", x: 93, y: 21, width: 3.2, height: 4.8, blocksMovement: false },
  { id: "trash-bin-outdoor-2", type: "trash-bin", x: 93, y: 61, width: 3.2, height: 4.8, blocksMovement: false },
  { id: "book-stack-left-01-1775312370671", type: "book-stack-left-01", x: 81.5, y: 40.5, width: 3.5, height: 2.5, blocksMovement: false },
  { id: "book-stack-left-02-1775312389776", type: "book-stack-left-02", x: 79.5, y: 41, width: 3.7, height: 2.9, blocksMovement: false },
  { id: "books-and-plant-left-01-1775312402060", type: "books-and-plant-left-01", x: 78, y: 43, width: 6.2, height: 3.5, blocksMovement: false },
  { id: "low-shelf-left-01-1775312419302", type: "low-shelf-left-01", x: 34, y: 1.5, width: 3.8, height: 3, blocksMovement: false },
  { id: "potted-plant-left-01-1775312441611", type: "potted-plant-left-01", x: 36.5, y: 5, width: 2.6, height: 2.5, blocksMovement: false },
  { id: "potted-plant-left-03-1775312460330", type: "potted-plant-left-03", x: 61, y: 2, width: 2.7, height: 3, blocksMovement: false },
  { id: "small-shelf-left-01-1775312478522", type: "small-shelf-left-01", x: 80.5, y: 43.5, width: 4.9, height: 3.3, blocksMovement: false },
  { id: "meeting-room-screen-01-1775312500006", type: "meeting-room-screen-01", x: 80.5, y: 18, width: 10.2, height: 6.8, blocksMovement: false },
  { id: "whiteboard-pixel-1775312530698", type: "whiteboard-pixel", x: 82.5, y: 18.5, width: 6.2, height: 4.6, blocksMovement: false },
  { id: "bookshelf-cabinet-01-1775312552355", type: "bookshelf-cabinet-01", x: 75, y: 40, width: 6.6, height: 8.1, blocksMovement: false },
  { id: "drawer-stack-beige-01-1775312644935", type: "drawer-stack-beige-01", x: 88.5, y: 2, width: 4.5, height: 6.9, blocksMovement: false },
  { id: "drawer-stack-gray-01-1775312659864", type: "drawer-stack-gray-01", x: 91, y: 40, width: 4.6, height: 7.5, blocksMovement: false },
  { id: "drawer-stack-gray-01-1775312671630", type: "drawer-stack-gray-01", x: 87, y: 1.5, width: 4.6, height: 7.5, blocksMovement: false },
  { id: "filing-cabinet-beige-tall-01-1775312689580", type: "filing-cabinet-beige-tall-01", x: 89.5, y: 0, width: 6.1, height: 9.4, blocksMovement: false },
  { id: "locker-dark-01-1775312722645", type: "locker-dark-01", x: 86, y: 0.5, width: 3.2, height: 8.5, blocksMovement: false },
  { id: "office-printer-copier-01-1775312738496", type: "office-printer-copier-01", x: 84.5, y: 43.5, width: 10.2, height: 8.7, blocksMovement: false },
  { id: "recycling-bin-01-1775312766966", type: "recycling-bin-01", x: 58.5, y: 2, width: 4, height: 5.7, blocksMovement: false },
  { id: "recycling-bin-01-1775312775699", type: "recycling-bin-01", x: 65, y: 36, width: 4, height: 5.7, blocksMovement: false },
  { id: "recycling-bin-01-1775312789616", type: "recycling-bin-01", x: 65, y: 54.5, width: 4, height: 5.7, blocksMovement: false },
  { id: "recycling-bin-01-1775312793716", type: "recycling-bin-01", x: 65, y: 73.5, width: 4, height: 5.7, blocksMovement: false },
  { id: "server-cabinet-tall-01-1775312799917", type: "server-cabinet-tall-01", x: 77.5, y: 0, width: 3.2, height: 9.4, blocksMovement: false },
  { id: "glass-corner-desk-01-1775312851051", type: "glass-corner-desk-01", x: 54.5, y: 86, width: 11.5, height: 9.2, blocksMovement: false },
  { id: "glass-corner-desk-01-1775312861616", type: "glass-corner-desk-01", x: 67.5, y: 86, width: 11.5, height: 9.2, blocksMovement: false },
  { id: "glass-monitor-desk-01-1775312862627", type: "glass-monitor-desk-01", x: 36, y: 86.5, width: 11.3, height: 9.9, blocksMovement: false },
  { id: "glass-monitor-desk-01-1775312879001", type: "glass-monitor-desk-01", x: 30.5, y: 86.5, width: 11.3, height: 9.9, blocksMovement: false },
  { id: "glass-note-desk-01-1775312889117", type: "glass-note-desk-01", x: 61, y: 87.5, width: 13.3, height: 9.6, blocksMovement: false },
  { id: "wooden-multi-monitor-desk-01-1775312976111", type: "wooden-multi-monitor-desk-01", x: 79.5, y: 86.5, width: 11.8, height: 9.8, blocksMovement: false },
  { id: "art-poster-abstract-01-1775312992596", type: "art-poster-abstract-01", x: 62, y: 86.5, width: 3.7, height: 5.7, blocksMovement: false },
  { id: "art-poster-space-01-1775313014766", type: "art-poster-space-01", x: 20, y: 1.5, width: 3.7, height: 5.2, blocksMovement: false },
  { id: "drawer-box-05-1775313048597", type: "drawer-box-05", x: 91.5, y: 7.5, width: 3.2, height: 3.3, blocksMovement: false },
  { id: "drawer-box-03-1775313059826", type: "drawer-box-03", x: 91.5, y: 10.5, width: 3.5, height: 3.4, blocksMovement: false },
  { id: "drawer-box-04-1775313060818", type: "drawer-box-04", x: 89.5, y: 8.5, width: 3.6, height: 3.5, blocksMovement: false },
  { id: "drawer-box-05-1775313069566", type: "drawer-box-05", x: 90.5, y: 11.5, width: 3.2, height: 3.3, blocksMovement: false },
  { id: "file-box-01-1775313079186", type: "file-box-01", x: 83, y: 6, width: 3.4, height: 2.7, blocksMovement: false },
  { id: "file-stack-02-1775313087420", type: "file-stack-02", x: 84.5, y: 7, width: 3.5, height: 3.2, blocksMovement: false },
  { id: "frame-square-01-1775313103811", type: "frame-square-01", x: 84, y: 1, width: 3.2, height: 2.8, blocksMovement: false },
  { id: "paper-stack-01-1775313110149", type: "paper-stack-01", x: 81.5, y: 5.5, width: 3.7, height: 3.5, blocksMovement: false },
  { id: "paper-stack-03-1775313125788", type: "paper-stack-03", x: 82.5, y: 7, width: 3.2, height: 3.5, blocksMovement: false },
  { id: "paper-stack-04-1775313138686", type: "paper-stack-04", x: 80.5, y: 7, width: 3.4, height: 2.8, blocksMovement: false },
  { id: "statue-small-01-1775313147130", type: "statue-small-01", x: 80, y: 2.5, width: 3.5, height: 2.7, blocksMovement: false },
  { id: "server-cabinet-tall-01-1775313170890", type: "server-cabinet-tall-01", x: 76.5, y: 0, width: 3.2, height: 9.4, blocksMovement: false },
  { id: "potted-plant-07-1775313241097", type: "potted-plant-07", x: 33, y: 4, width: 3.7, height: 4.1, blocksMovement: false },
  { id: "meeting-room-table-chairs-01-1775313271474", type: "meeting-room-table-chairs-01", x: 7.5, y: 88.5, width: 12.9, height: 9.2, blocksMovement: false },
  { id: "file-box-01-1775313299374", type: "file-box-01", x: 91, y: 53, width: 3.4, height: 2.7, blocksMovement: false },
  { id: "locker-beige-01-1775313325383", type: "locker-beige-01", x: 74, y: 57.5, width: 4.2, height: 8.1, blocksMovement: false },
  { id: "rolling-whiteboard-01-1775313375475", type: "rolling-whiteboard-01", x: 1, y: 86.5, width: 10.8, height: 9.2, blocksMovement: false },
  { id: "bookshelf-pixel-1775315768643", type: "bookshelf-pixel", x: 2.5, y: 0, width: 7.2, height: 8.9, blocksMovement: false },
  { id: "frame-square-02-1775315931355", type: "frame-square-02", x: 16.5, y: 87.5, width: 3.2, height: 2.8, blocksMovement: false },
  { id: "frame-square-01-1775315942974", type: "frame-square-01", x: 78, y: 18, width: 3.2, height: 2.8, blocksMovement: false },
  { id: "meeting-room-screen-01-1775316022372", type: "meeting-room-screen-01", x: 19, y: 86.5, width: 10.2, height: 6.8, blocksMovement: false }
];
